...
namespace constants {
    ...
    const std::string EXPLOSION_IMAGE_PATH = "sprites/Explosion.png";
    const std::string PLAYER_IMAGE_PATH    = "sprites/kenney_simple-space/PNG/Default/ship_G.png";
    const std::string HITMARKER_IMAGE_PATH = "sprites/Hitmarker.png";
    const std::string RPG_IMAGE_PATH       = "sprites/RPG.png";
    const std::string INVADER_PATH         = "sprites/kenney_simple-space/PNG/Default/enemy_E.png";
    const std::string ROBOTO_FONT_PATH     = "SFMLFonts/roboto/Roboto-Bold.ttf";
    const std::string POWER_UP_PATH        = "sprites/kenney_simple-space/PNG/Default/meteor_squareDetailedLarge.png";
}
